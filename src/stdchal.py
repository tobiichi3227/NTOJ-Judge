...
class StdChal:
    ...
    async def judge_diff_4_java(
                ...
                "cmd": [
                    {
                        ...
                        "copyIn": {f"{class_name}.class": {"fileId": fileid}},
                        "copyOut": ["stdout"],
                    }
                ]
            }
        ...
        if res["status"] == GoJudgeStatus.Accepted:
            with open(ans_path, "r") as ans_file:
                res_pass = await executor_server.diff_ignore_space(
                    res["files"]["stdout"], ans_file.read()
                )
                if res_pass:
    ...
    async def judge_diff(
        self, args, test_groups, fileid, in_path, ans_path, timelimit, memlimit
    ):
        result = self.results[test_groups]
        if result["status"] in [
            Status.TimeLimitExceeded,
                ...
                "cmd": [
                    {
                        ...
                        "procLimit": 10,
                        "copyIn": {"a.cpp": {"src": self.code_path}},
                        "copyOut": ["stderr"],
                        "copyOutCached": ["a"],
                    }
                ]
                ...
                "cmd": [
                    {
                        ...
                        "procLimit": 10,
                        "copyIn": {"a.rs": {"src": self.code_path}},
                        "copyOut": ["stderr"],
                        "copyOutCached": ["a"],
                    }
                ]
                ...
                "cmd": [
                    {
                        ...
                        "memoryLimit": 536870912,
                        "procLimit": 10,
                        "copyIn": {"a.py": {"src": self.code_path}},
                        "copyOut": ["stderr"],
    ...
    async def comp_java(self):
                ...
                "cmd": [
                    {
                        ...
                        "procLimit": 25,
                        "copyIn": {f"{main_class_name}.java": {"src": self.code_path}},
                        "copyOut": ["stdout"],
        ...
        return (
            self.compile_update_result(res, f"{main_class_name}.class"),
            main_class_name,
        )
    ...
    async def comp_make(self):
        ...
        for file in os.listdir(res_make_path):
            if os.path.isfile(os.path.join(res_make_path, file)):
                copy_in[file] = {"src": os.path.join(res_make_path, file)}
                ...
                "cmd": [
                    {
                        ...
                        "procLimit": 10,
                        "copyIn": {"main.cpp": {"src": self.code_path}, **copy_in},
                        "copyOut": ["stderr"],
                        "copyOutCached": ["a"],
                    }
                ]
